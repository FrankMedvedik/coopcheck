        ...
        : NotifyPropertyChanged, ISettingsAppearanceViewModel
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            Themes.Add(new Link
            {
                ...
                Source = new Uri("/CoopCheck.WPF;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative)
            });
            Themes.Add(new Link
            {
                DisplayName = "love",
                Source = new Uri("/CoopCheck.WPF;component/Assets/ModernUI.Love.xaml", UriKind.Relative)
            });
            Themes.Add(new Link
            {
                DisplayName = "snowflakes",
                Source = new Uri("/CoopCheck.WPF;component/Assets/ModernUI.Snowflakes.xaml", UriKind.Relative)
            });
        ...
        public Link SelectedTheme
        {
            ...
            set
            {
                if (selectedTheme != value)
                {
                    ...
                    Properties.Settings.Default.Theme = value.Source.ToString();
                }
            }
        }
        ...
        public Color SelectedAccentColor
        {
            ...
            set
            {
                if (selectedAccentColor != value)
                {
                    ...
                    Properties.Settings.Default.AccentColor = value.ToString();
                }
            }
        }
