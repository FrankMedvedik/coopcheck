...
{
    public class JobFinderBatchReportViewModel : ViewModelBase
    {
        ...
        public JobFinderBatchReportViewModel()
        {
            ShowGridData = false;
        }
        ...
        public async void GetBatches()
        {
            ...
            try
            {
                ...
                var v = await RptSvc.GetJobBatchRpt(JobReportCriteria.SelectedJob.JobNum );
