...
{
    public class JobFinderPaymentReportViewModel : ViewModelBase
    {
        ...
        public JobFinderPaymentReportViewModel()
        {
            ShowGridData = false;
        ...
        {
            WorkPayments = await RptSvc.GetAllBatchPayments(BatchNum);
