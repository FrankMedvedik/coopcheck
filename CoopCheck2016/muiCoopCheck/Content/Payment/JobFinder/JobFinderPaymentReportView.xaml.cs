...
namespace CoopCheck.WPF.Content.Payment.JobFinder
{
    /// <summary>
    /// </summary>
    public partial class JobFinderPaymentReportView : UserControl
    {
        private JobFinderPaymentReportViewModel _vm = null;
       
        public JobFinderPaymentReportView()
        {
            InitializeComponent();
            _vm = new JobFinderPaymentReportViewModel();
            DataContext = _vm;
        ...
        private async Task RefreshChildren(vwBatchRpt vwBatchRpt)
        {
            if (vwBatchRpt == null) return;
               if((SelectedvwBatchRpt == null) 
                ...
                {
                    _vm.JobReportCriteria.SelectedBatch.batch_num = vwBatchRpt.batch_num;
                    _vm.RefreshAll();
                });
        ...
        {
            brv.JobReportCriteria = jrcv.JobReportCriteria;
            _vm.JobReportCriteria = jrcv.JobReportCriteria;
