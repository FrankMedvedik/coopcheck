...
namespace FirstFloor.ModernUI.App.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/CoopCheck.WPF;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "love", Source = new Uri("/CoopCheck.WPF;component/Assets/ModernUI.Love.xaml", UriKind.Relative) });
