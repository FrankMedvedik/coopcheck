...
namespace WEb.API2.Owin.NinJect.Controllers
{
        ...
        public class SwiftPaymentController : ApiController, ISwiftPaymentController
        {
        ...
        public List<vwPayment> Get()
        {
            //log.Info(string.Format("get SwiftPayments batchNum {0}", batchNum));
            return _ctx.vwPayments.Take(100).ToList();
        }
        // POST api/SwiftPayment/SwiftPay?batchNum=1
